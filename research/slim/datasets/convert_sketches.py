...
# ==============================================================================
r"""Downloads and converts sketches data to TFRecords of TF-Example protos.

This module downloads the sketches data, uncompresses it, reads the files
that make up the sketches data and creates two TFRecord datasets: one for train
...
def run(dataset_dir):
  ...
  """
    ...
    print('\nFinished converting the sketches dataset!')
